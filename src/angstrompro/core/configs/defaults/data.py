DEFAULTS = {
    ...
    "channel_manager": {
        "nanonis_3ds": {
            ...
            "Amplitude":  {"aliases": ["Amplitude", "Amp"],                         "load_by_default": False},
            "Phase":      {"aliases": ["Phase"],                                    "load_by_default": False},
            "Frequency":  {"aliases": ["Frequency shift", "Freq"],                  "load_by_default": False},
        },
        "nanonis_sxm": {
            "__auto_load__": False,
